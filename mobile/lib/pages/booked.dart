                            ...
                            child: Stack(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text("Descripiton sdfsdjjhl sdgfh sgdjf shjd fghsjag dfjk ghfkgf fhgf g fgh jgf gfh fjgf gf ghdgfdsesers ytrtu uotyo  khjkj bbcfg fjffghf ffghjhfgh",
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize: 18,
                                ...
                                Positioned(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      IconButton(onPressed: (){}, icon: Icon(Icons.star), color: Col.primary,),
                                      IconButton(onPressed: (){}, icon: Icon(Icons.star), color: Col.primary,),
                                      IconButton(onPressed: (){}, icon: Icon(Icons.star), color: Col.primary,),
                                      IconButton(onPressed: (){}, icon: Icon(Icons.star), color: Col.primary,),
                                      IconButton(onPressed: (){}, icon: Icon(Icons.star), color: Col.primary,),
